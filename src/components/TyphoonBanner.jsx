...
const RISK_DAYS = [
  ...
  },
  {
    ...
    level: "🔴",
    color: COLORS.warn,
    text: "红霞凌晨在惠来～汕头一带登陆，广铁已宣布省内铁路停运——上午酒店/商场躺平，落波后走 ⭐东铁→落马洲支线→福田口岸→深圳地铁4号线直达深圳北（全程轨道+室内，八达通直接刷）。罗湖口岸备胎；跨境巴士口岸别去",
  },
  {
    date: "7/27 一",
    level: "🔴",
    color: COLORS.warn,
    text: "26日全省停运后，早班 C7220 属恢复第一梯队、停运概率不低——票留着（停运自动全退），改当天下午班次即可，红霞下午已远去韶关方向",
  },
  {
    date: "7/28+",
    level: "🟢",
...
const CHECKLIST = [
  "7/26 高铁已官宣停运 → 不坐高铁，走福田口岸地铁线（不用买票）；已购西九龙票等自动退",
  "7/27 早 C7220 深圳北→汕头 照常预购，停运自动全退、改下午班次",
  "装好：香港天文台 App（盯风球）· 12306（停运公告提前一晚发）",
  "口岸时间：福田/罗湖 06:30–24:00 · 皇岗 24h（极端备胎）",
  "便携雨衣（台风天伞是废的）· 充电宝充满",
];
